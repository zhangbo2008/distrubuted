...
public class SqlUtil {
     ...
     * @return 转驼峰后的字段
     */
    public static String underLineToHump(String message) {
        while(true) {
     ...
     */
    public static Class<?> getFieldClass(Object o, String message) throws NoSuchFieldException {
     ...
     * @throws SQLException
     */
    public static PreparedStatement sqlHandel(String sql, Parameter[] parameters, Object[] args, Connection con) throws SQLException {
    ...
    public Method findMethod(Object o, String name , boolean declared, Object... args) {
