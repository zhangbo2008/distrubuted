...
import com.hc.hccommon.DataSourceEnum;
import com.hc.hccommon.DynamicDataSource;
import com.hc.hccommon.util.SpringContextUtil;
...
public abstract class BaseServiceImpl<Mapper, Record, Example> implements BaseService<Record, Example> {
	...
	public int countByExample(Example example) {
		try {
			...
			// 当被调用的方法的内部抛出了异常而没有被捕获时，将由此异常接收。invoke处发生
			e.printStackTrace();
		} catch (NoSuchMethodException e) {
			// 找不到指定的方法，getDeclaredMethod处发生
			e.printStackTrace();
		}
